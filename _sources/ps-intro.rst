...
.. raw:: html
    ...
    <p>Click on the following link to go the practice problems: <a id="ps-pred"><font size="+2">Prediction</font></a></p>
...
.. raw:: html
   ...
   <script type="text/javascript" >
      ...
      window.onload = function() {
        ...
        a = document.getElementById("ps-pred")
        a.href = "ps-predict.html"
      };
